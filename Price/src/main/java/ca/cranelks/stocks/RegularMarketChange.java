...
public class RegularMarketChange {
    ...
    public RegularMarketChange withRaw(Double raw) {
        this.raw = raw;
        return this;
    }
    ...
    public RegularMarketChange withFmt(String fmt) {
        this.fmt = fmt;
        return this;
    }
    ...
    public RegularMarketChange withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
