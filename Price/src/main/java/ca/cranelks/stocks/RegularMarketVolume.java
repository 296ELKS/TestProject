...
public class RegularMarketVolume {
    ...
    public RegularMarketVolume withRaw(Integer raw) {
        this.raw = raw;
        return this;
    }
    ...
    public RegularMarketVolume withFmt(String fmt) {
        this.fmt = fmt;
        return this;
    }
    ...
    public RegularMarketVolume withLongFmt(String longFmt) {
        this.longFmt = longFmt;
        return this;
    }
    ...
    public RegularMarketVolume withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
