...
public class RegularMarketOpen {
    ...
    public RegularMarketOpen withRaw(Double raw) {
        this.raw = raw;
        return this;
    }
    ...
    public RegularMarketOpen withFmt(String fmt) {
        this.fmt = fmt;
        return this;
    }
    ...
    public RegularMarketOpen withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
