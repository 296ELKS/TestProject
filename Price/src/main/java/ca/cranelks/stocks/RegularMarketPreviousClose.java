...
public class RegularMarketPreviousClose {
    ...
    public RegularMarketPreviousClose withRaw(Double raw) {
        this.raw = raw;
        return this;
    }
    ...
    public RegularMarketPreviousClose withFmt(String fmt) {
        this.fmt = fmt;
        return this;
    }
    ...
    public RegularMarketPreviousClose withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
