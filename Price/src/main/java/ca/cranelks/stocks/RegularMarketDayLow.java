...
public class RegularMarketDayLow {
    ...
    public RegularMarketDayLow withRaw(Double raw) {
        this.raw = raw;
        return this;
    }
    ...
    public RegularMarketDayLow withFmt(String fmt) {
        this.fmt = fmt;
        return this;
    }
    ...
    public RegularMarketDayLow withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
