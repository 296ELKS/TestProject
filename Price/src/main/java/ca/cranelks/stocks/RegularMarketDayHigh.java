...
public class RegularMarketDayHigh {
    ...
    public RegularMarketDayHigh withRaw(Double raw) {
        this.raw = raw;
        return this;
    }
    ...
    public RegularMarketDayHigh withFmt(String fmt) {
        this.fmt = fmt;
        return this;
    }
    ...
    public RegularMarketDayHigh withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
