...
public class PriceHint {
    ...
    public PriceHint withRaw(Integer raw) {
        this.raw = raw;
        return this;
    }
    ...
    public PriceHint withFmt(String fmt) {
        this.fmt = fmt;
        return this;
    }
    ...
    public PriceHint withLongFmt(String longFmt) {
        this.longFmt = longFmt;
        return this;
    }
    ...
    public PriceHint withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
